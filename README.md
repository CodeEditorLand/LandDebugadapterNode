...
-   _vscode-debugprotocol_: Npm module with declarations for the json-based VS
    Code debug protocol.<br>
...
-   _vscode-debugadapter_: Npm module to implement a VS Code debug adapter using
    Node.js as a runtime.<br>
...
-   _vscode-debugadapter-testsupport_: Npm module with support classes for
    testing VS Code debug adapters.<br>
